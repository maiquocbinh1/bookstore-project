        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Kho sách đa dạng</h3>
              <p className="text-gray-600">Hàng nghìn đầu sách từ nhiều thể loại khác nhau</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-primary-100 rounded-full mb-4">
                <svg className="w-8 h-8 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Miễn phí vận chuyển cho đơn hàng trên 500k</p>
            </div>
          </div>
        </div>
      </section>
